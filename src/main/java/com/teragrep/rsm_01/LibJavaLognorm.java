...
public interface LibJavaLognorm  extends Library {
    ...
    @FieldOrder({ "LN_CTXOPT_ALLOW_REGEX", "LN_CTXOPT_ADD_EXEC_PATH", "LN_CTXOPT_ADD_ORIGINALMSG", "LN_CTXOPT_ADD_RULE", "LN_CTXOPT_ADD_RULE_LOCATION"})
    class OptionsStruct extends Structure {
        public boolean LN_CTXOPT_ALLOW_REGEX;
        public boolean LN_CTXOPT_ADD_EXEC_PATH;
        public boolean LN_CTXOPT_ADD_ORIGINALMSG;
        public boolean LN_CTXOPT_ADD_RULE;
        public boolean LN_CTXOPT_ADD_RULE_LOCATION;
    }
